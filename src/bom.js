var navigator = {
	appCodeName:"Mozilla",
	appName:"Netscape",
	appVersion: "5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.81 Safari/537.36",
	cookieEnabled: true,
	doNotTrack: null,
	hardwareConcurrency: 8,
	language: "zh-CN",
	languages:["zh","zh-CN","en-US","en"],
	platform: "Win32",
	product: "Gecko",
	productSub: "20030107",
...
var $CONFIG = {};
$CONFIG['islogin']='0'; 
$CONFIG['oid']='1696137703'; 
$CONFIG['page_id']='1005051696137703'; 
$CONFIG['onick']='大展hong兔'; 
$CONFIG['skin']='skin002'; 
$CONFIG['background']=''; 
$CONFIG['scheme']=''; 
$CONFIG['colors_type']=''; 
$CONFIG['timeDiff']=(new Date() - 1438243248000); 
$CONFIG['servertime']='1438243248'; 
$CONFIG['location']='page_100505_home'; 
$CONFIG['pageid']=''; 
$CONFIG['domain']='100505'; 
$CONFIG['title_value']='大展hong兔的微博_微博'; 
$CONFIG['$webim']='1'; 
$CONFIG['miyou']='1'; 
$CONFIG['brand']='0'; 
$CONFIG['bigpipe']='true'; 
...
$CONFIG['version']='28dc7c6bed4863b5'; 
...
function bJ(a){
	...
	function u(){
		...
		if(!!o){bC(o,a);bB(L,a);n?h(u,n):u()}
}
//end of function bJ(a)
...
function bo(a,b){
	...
	if(!Y(b)){
		...
		bh(d,"id",c);
		g.appendChild(d);
		try{d.styleSheet.cssText=a}catch(f){d.appendChild(e.createTextNode(a))}
		bi[b]=c
	}
}
...
function bl(a){
	...
	if(m){
		...
		if(!c){
			b=x();c=bd("style");bh(c,"type","text/css");
			bh(c,"id",b);g.appendChild(c);bj[b]=[]
		}
		(c.styleSheet||c.sheet).addImport(a);bj[b].push(a)
	}else{
		b=x();
		var d=bd("link");
		bh(d,"rel","stylesheet");
...
function bk(a,c,d){
	function j(){
		if(parseInt(b.getComputedStyle?getComputedStyle(e,null)[f]:e.currentStyle&&e.currentStyle[f])===42)
			i();
		else if(--g>0)
			h(j,10);
		else{
	...
	if(!Y(a,c)){
		bl(a);e=bd("div");e.id=d;bf(e);h(j,50)
	}
}
...
FM.view({"domid":"pl_lib","js":"home/js/pl/lib.js?version=28dc7c6bed4863b5","jsDefer":true});
